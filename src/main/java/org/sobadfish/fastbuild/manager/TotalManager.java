...
import org.sobadfish.fastbuild.manager.data.PlayerDataManager;
import org.sobadfish.fastbuild.manager.data.PlayerTopManager;
import org.sobadfish.fastbuild.panel.lib.AbstractFakeInventory;
import org.sobadfish.fastbuild.room.config.GameRoomConfig;
import org.sobadfish.fastbuild.room.event.defaults.CustomEvent;
import org.sobadfish.fastbuild.room.event.defaults.VoteEvent;
...
public class TotalManager {
     ...
     * 游戏管理员指令
     * */
    public static final String COMMAND_ADMIN_NAME = "fba";

    /**
     * 游戏内喊话指令
     * */
    public static final String COMMAND_MESSAGE_NAME = "fbs";

    /**
     * 小游戏名称
     * */
    public static final String GAME_NAME = "FastBuild";
    ...
    public static void init(PluginBase pluginBase){
        ...
        RoomEventManager.register("vote", VoteEvent.class);
        ThreadManager.init();
    }
